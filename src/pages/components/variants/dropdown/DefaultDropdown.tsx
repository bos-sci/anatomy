...
const DefaultDropdown = (): JSX.Element => {
  return (
    <>
      ...
      <iframe
        title="Dropdown menu Storybook story"
        src="https://main--64e769384ef6b440f819fcec.chromatic.com/?path=/story/components-dropdown-menu--playground&full=1&shortcuts=false&singleStory=true"
        width="100%"
        height="400"
