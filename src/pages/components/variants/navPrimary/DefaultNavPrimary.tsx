...
const DefaultNavPrimary = (): JSX.Element => {
  ...
  return (
    <>
      ...
      <iframe
        title="Default primary nav Storybook story"
        src="https://main--64e769384ef6b440f819fcec.chromatic.com/?path=/story/components-primary-navigation--playground&full=1&shortcuts=false&singleStory=true"
        width="100%"
        height="800"
